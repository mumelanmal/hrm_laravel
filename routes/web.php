...
Route::middleware(['auth'])->group(function () {
    ...
    Volt::route('employees/resign/{employee}', 'employees.resigned-show')->name('resigned.show');
    ...
    Route::post('employees/{employee}/resign', [EmployeeController::class, 'resign'])->name('employees.resign.submit');
    Route::post('employees/{id}/restore', [EmployeeController::class, 'restore'])->name('employees.restore');
    Route::delete('employees/{id}/force', [EmployeeController::class, 'forceDestroy'])->name('employees.forceDestroy');
});
